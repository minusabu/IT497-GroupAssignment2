...
#Mining for tweets from eBay for day 1
...
#Mining for tweets from eBay for day2
...
#Mining for tweets from eBay for day 3
...
#Mining for tweets from eBay for day 4
...
#Create a dataframe of the required tweet data and write it into a text file for day 4
...
#Mining for tweets from eBay for day 5
